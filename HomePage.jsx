          ...
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:72,alignItems:'center'}} className="hero-inner">
            <div>
              ...
              <div style={{display:'flex',gap:12,flexWrap:'wrap',alignItems:'center',marginBottom:48}}>
                <button onClick={() => go('contact')} style={{display:'inline-flex',alignItems:'center',gap:8,padding:'18px 36px',borderRadius:999,background:'#4F6EF7',border:'none',cursor:'pointer',fontFamily:"'DM Sans',sans-serif",fontSize:17,fontWeight:700,color:'#fff',letterSpacing:'-0.01em',boxShadow:'0 0 0 0 rgba(79,110,247,0.4), 0 2px 8px rgba(79,110,247,0.3)',transition:'all 220ms'}}>
                  Pide tu demo gratis
        ...
        <div className="container" style={{position:'relative',zIndex:1}}>
          <div style={{textAlign:'center',maxWidth:640,margin:'0 auto'}}>
            ...
            <div style={{display:'flex',gap:12,justifyContent:'center',flexWrap:'wrap'}}>
              <button onClick={() => go('contact')} style={{display:'inline-flex',alignItems:'center',gap:8,padding:'18px 36px',borderRadius:999,background:'#4F6EF7',border:'none',cursor:'pointer',fontSize:17,fontWeight:700,color:'#fff',fontFamily:"'DM Sans',sans-serif",boxShadow:'0 0 0 0 rgba(79,110,247,0.4), 0 2px 8px rgba(79,110,247,0.3)',transition:'all 220ms'}}>
                Pide tu demo gratis →
              </button>
